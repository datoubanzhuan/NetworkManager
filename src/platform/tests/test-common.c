...
nmtstp_ip4_route_exists (const char *ifname, guint32 network, int plen, guint32 metric)
{
	...
	g_assert (ifname && nm_utils_iface_name_is_valid (ifname, NULL));
                       ...
                       const char *name)
{
	...
	g_assert (nm_utils_iface_name_is_valid (name, NULL));
                       ...
                       NMLinkType link_type)
{
	...
	g_assert (!name || nm_utils_iface_name_is_valid (name, NULL));
